...
class Weapon(object):
    def __init__(self, data: Union[None, Dict[str, str]]):
        self.isnewweapon = False
        self.additionalmodcmds = ""
        if data is None:
            self.line = {}
            self.origid = None
            self.name = "New Weapon"
            self.att = 0
            self.def_ = 0
            self.len = 0
            self.nratt = 1
            ...
            self.secondaryeffectid = -1
            self.secondaryeffectalways = None
            self.secondaryeffectalwaysid = -1
            self.effect = 2
            self.damage = 0
            self.spec = 0
            self.range = 0
            ...
            self.uniqueid = f"vanilla-{self.origid}"
