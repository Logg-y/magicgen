...
secondary_params_int = ["damage", "schools", "spelltype", "aoe", "power", "skipchance", "range", "precision", "nreff", "pathlevel", "fatiguecost","maxpower","maxbounces","casttime","paths","fatiguecostpereffect", "anysummon"]
