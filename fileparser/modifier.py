...
modifier_params_int = ["damage", "schools", "spelltype", "aoe", "power", "skipchance", "range", "precision", "nreff", "pathlevel", "fatiguecost","maxpower","maxbounces","casttime", "effect", "givecloudsfx", "aicastmod"]
modifier_params_str = []
