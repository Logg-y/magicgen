        ...
        for x in ["shapechange", "firstshape", "secondshape", "secondtmpshape", "forestshape", "plainshape",
            ...
            if hasattr(unitobj, x):
                ...
                if uid not in tested and uid > 0:
                    ...
                    if not self.compatibility(unitobj, tested=tested):
                        return False
