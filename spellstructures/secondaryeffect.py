...
class SpellSecondaryEffect(object):
	def __init__(self):
		self.spelltype = 0
		self.params = ["power", "spelltype", "range", "precision", "damage", "aoe", "casttime", "nreff", "skipchance", "fatiguecost", "maxbounces", "scalecost", "scalerate", "pathperresearch", "scalefatigueexponent", "nextspell", "unitmod"]
		self.power = 0
		self.spelltype = 0
		self.range = 0
		self.precision = 0
