...
class WeaponMod(object):
	def __init__(self):
		self.spelltype = 0
		self.name = ""
		self.params = ["att", "def_", "len", "nratt", "ammo", "secondaryeffectid", "secondaryeffectalwaysid", "effect", "damage", "spec", "range", "aoe"]
		self.att = 0
		self.def_ = 0
		self.len = 0
		self.nratt = 0
	...
	def apply(self, unit):
		...
		for wpn in unit.weapons:
			...
			if self.compatibility(wpn) and wpn.origid not in replacements:
				...
				for n in breakdown:
					if n == 1: out += "#twohanded\n"
					elif n == 2: out += "#flail\n"
					elif n == 3: out += "#demonundead\n"
					elif n == 4: out += "#magiconly\n"
					elif n == 5: out += "#fire\n"
					elif n == 6: out += "#armorpiercing\n"
					elif n == 7: out += "#armornegating\n"
					elif n == 9: out += "#cold\n"
					elif n == 11: out += "#shock\n"
					elif n == 12: out += "#mrnegates\n"
					elif n == 13: out += "#poison\n"
					elif n == 14: out += "#ignoreshield\n"
					elif n == 15: out += "#sacredonly\n"
					elif n == 16: out += "#aironly\n"
					elif n == 17: out += "#mind\n"
					elif n == 18: out += "#friendlyimmune\n"
					elif n == 19: out += "#undeadimmune\n"
					elif n == 20: out += "#defnegate\n"
					elif n == 21: pass # not #magic
					elif n == 22: out += "#enemyimmune\n"
					elif n == 23: out += "#uwok\n"
					elif n == 24: out += "#mrnegateseasily\n"
					elif n == 25: out += "#uwonly\n"
					elif n == 26: out += "#ironweapon\n"
					elif n == 27: out += "#bonus\n"
					elif n == 28: out += "#demonimmune\n"
					elif n == 29: out += "#inanimateimmune\n"
					#elif n == 30: out += "#bloodletting\n"
					elif n == 31: out += "#charge\n"
					elif n == 33: out += "#usedinemelee\n"
					# higher charge bonus cap
					#elif n == 36: out += "#usedinemelee\n"
					elif n == 37: out += "#norepel\n"
					elif n == 38: out += "#pierce\n"
					elif n == 39: out += "#blunt\n"
					elif n == 40: out += "#slash\n"
					elif n == 41: out += "#acid\n"
					elif n == 42: out += "#sizeresist\n"
					elif n == 43: out += "#melee50\n"
					elif n == 44: out += "#hardmrneg\n"
					elif n == 45: out += "#unrepel\n"
					elif n == 46: out += "#flyingimmune\n"
					elif n == 47: out += "#constructimmune\n"
					elif n == 48: out += "#animalonly\n"
					elif n == 49: out += "#hithead\n"
					elif n == 58: out += "#halfstr\n"
